...
import com.zoya.assistant.utils.AndroidActionsHelper
    ...
    Scaffold(
        ...
        Column(
            ...
            QuickActionButton(
                ...
                val res = AndroidActionsHelper.performWebSearch(context, "JARVIS AI Assistant")
                actionResult = res.getOrElse { "Failed to launch web search." }
            }
        }
    }
}
